...
def upgrade() -> None:
    ...
    if not inspector.has_table('credits_ledger', schema='credits'):
    ...
    if not inspector.has_table('marketplace_listings', schema='credits'):
    ...
    if not inspector.has_table('processed_events', schema='credits'):
