...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column('type', sa.Enum('individual', 'team', name='account_type'), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('role', sa.Enum('owner', 'admin', 'member', name='account_member_role'), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('role', sa.Enum('owner', 'admin', 'member', name='invite_role'), nullable=False),
